...
double ptc_float(const double x, const double y, const double z, double &a, double &b, double &c, double &A, double &B, double &C, double &D) {
  if (x <= y) {
    if (y <= z) {
      a = x, b = y, c = z;
    } else if (x <= z) {
